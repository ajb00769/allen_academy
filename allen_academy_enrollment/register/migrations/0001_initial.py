...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='EmployeeDetail',
            fields=[
                ('account_id', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, primary_key=True, serialize=False, to='register.allaccount')),
                ...
                ('teaching_year_lvl', models.CharField(choices=[('REGS', 'Regular Staff'), ('PHDT', 'PHD Teacher'), ('MSTT', 'Masters Teacher'), ('LAWT', 'Law Teacher'), ('COLT', 'College Teacher'), ('SHST', 'High School Teacher'), ('MDST', 'Middle School Teacher'), ('EMST', 'Elementary School Teacher')], default='REGS', max_length=16)),
            ],
        ),
        migrations.CreateModel(
            name='StudentDetail',
