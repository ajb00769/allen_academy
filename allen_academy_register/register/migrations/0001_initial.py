# Generated by Django 4.2.6 on 2024-03-23 14:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('middle_name', models.CharField(default=None, max_length=80)),
                ...
                ('phone', models.CharField(max_length=16, validators=[django.core.validators.RegexValidator(message="Phone number must follow the format '+99999999' between 8-15 digits long.", regex='^\\+?\\1?\\d{8,15}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=80)),
                ('middle_name', models.CharField(default=None, max_length=80)),
                ('suffix', models.CharField(choices=[('JR', 'Junior'), ('SR', 'Senior'), ('II', 'The second'), ('III', 'The third'), ('IV', 'The fourth'), ('V', 'The fifth')], default=None, max_length=3)),
                ('birthday', models.DateField()),
                ('address', models.CharField(max_length=255)),
                ('phone', models.CharField(default=None, max_length=16, validators=[django.core.validators.RegexValidator(message="Phone number must follow the format '+99999999' between 8-15 digits long.", regex='^\\+?\\1?\\d{8,15}$')])),
