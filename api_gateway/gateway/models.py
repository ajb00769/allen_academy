...
from model_utils.validators import (
    phone_validator,
    student_age_validator,
    staff_parent_age_validator,
)
from model_utils.choices import (
...
from model_utils.year_utils import get_current_year, get_year_choices, get_current_date
...
class StudentSubject(models.Model):
    ...
    subject_code = models.ForeignKey("Subject", to_field="subject_code")
